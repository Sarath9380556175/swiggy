...
console.log(responses);
 ...
 axios({
     url:'https://apple-tart-77279.herokuapp.com/login',
     method:'POST',
     headers:{'content-Type':'application/json'},
     data:{
 email:emailid,
...
{ isfacebookUserLoggedIn==true? <div style={{backgroundColor:'#ce0505',height:'50px',paddingTop:'3px'}}>
           ...
           : isLoggedIn==true && logindetails.length!=0 ? logindetails.map((item)=>{
            return  <div style={{backgroundColor:'#ce0505',height:'50px',paddingTop:'3px'}} >
         ...
         : isLoggedIn==false || isfacebookUserLoggedIn==false? <div style={{backgroundColor:'#ce0505',height:'50px',paddingTop:'3px'}}>
         <div className=" pt-2 bg-white logo" style={{display:'inline-block',marginLeft:'37px'}} onClick={this.handleClick}>e!</div>
...
<div>
<GoogleLogin
    clientId="336603315194-90olmlvijk9jd9um8ugpu9dgu14slnsq.apps.googleusercontent.com"
